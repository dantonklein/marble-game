...
void OPT3001_Init(void) {
    ...
    OPT3001_WriteRegister(OPT3001_CONFIG_ADDR,0b1100011000000000);
    return;
}
...
void OPT3001_WriteRegister(uint8_t addr, uint16_t data) {
    ...
    uint8_t input[3] = { addr , (data >> 8), (data & 0xFF)};
    I2C_WriteMultiple(I2C_A_BASE, OPT3001_ADDR, input, 3);
    return;
...
uint16_t OPT3001_ReadRegister(uint8_t addr) {
    ...
    I2C_ReadMultiple(I2C_A_BASE, OPT3001_ADDR, output, 2);
